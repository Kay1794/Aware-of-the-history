...
parser.add_argument(
    "--model_type", default="lanegcn", type=str,  help="model type"
)
parser.add_argument("--cluster_seperate", action="store_true")
parser.add_argument("--full_system_actor", action="store_true")
parser.add_argument("--full_system_map", action="store_true")
...
parser.add_argument("--higherorder_diff", action="store_true")
